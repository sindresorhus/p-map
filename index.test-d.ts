...
import pMap, {pMapIterable, type Options, type Mapper, pMapSkip, setDefaultConcurrency, getDefaultConcurrency} from './index.js';
...
expectType<void>(setDefaultConcurrency(50));
expectType<number>(getDefaultConcurrency());
